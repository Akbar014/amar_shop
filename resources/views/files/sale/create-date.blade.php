...
@section('title') Add sale with date @endsection
@section('pos') active show-sub @endsection
@section('sale-create-date') active @endsection
...
@section('content')
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Sale create with date</span>
        </nav>
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                @endif
                <form action="{{ route('sale.store.date') }}" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
                    @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="c_name" id="c_name" placeholder="Enter customer name" autocomplete="off" requried />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="email" class="form-control" name="c_email" id="c_email" placeholder="Enter customer email" autocomplete="off"  />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="c_number" id="c_number" placeholder="Enter customer phone" autocomplete="off"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
