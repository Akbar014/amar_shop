...
@section('challan-create') active @endsection
    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                @endif
                <form action="{{ route('challan.store') }}" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
                    @csrf
                    <div class="load-animate animated fadeInUp">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" rows="4" name="delivery_address" id="delivery_address" placeholder="Enter delivery address"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="driver" id="driver" placeholder="Enter driver name" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="vehicle" id="vehicle" placeholder="Enter vehicle number" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="request" id="request" placeholder="Enter request by name" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
