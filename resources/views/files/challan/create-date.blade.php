...
@section('challan-create-date') active @endsection
...
@section('content')
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Challan create</span>
        </nav>
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                @endif
                <form action="{{ route('challan.store.date') }}" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
                    @csrf
                    <div class="load-animate animated fadeInUp">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="c_number" id="c_number" placeholder="Enter customer phone" autocomplete="off" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" rows="4" name="c_address" id="c_address" placeholder="Enter customer address" required></textarea>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" rows="4" name="delivery_address" id="delivery_address" placeholder="Enter delivery address" required></textarea>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" rows="4" name="narration" id="narration" placeholder="Enter your narration"></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="datetime-local" class="form-control" name="created_at" id="created_at" placeholder="Enter date" autocomplete="off" required />
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="driver" id="driver" placeholder="Enter driver name" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="vehicle" id="vehicle" placeholder="Enter vehicle number" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="request" id="request" placeholder="Enter request by name" autocomplete="off" required />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="ho" id="ho" placeholder="Enter H.O" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <table class="table table-condensed table-striped" id="invoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="remarks[]" id="remarks_1" class="form-control quantity" autocomplete="off"></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-outline-success">Save challan</button>
                        </div>
