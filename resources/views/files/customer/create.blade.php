                ...
                <form action="{{ url('/customers') }}" method="POST">
                    ...
                    <div class="row row-sm">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="phone" placeholder="Enter Customer Phone no" required />
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="form-layout-footer mt-3">
                            <button class="btn btn-info mg-r-5" type="submit" style="cursor: pointer;">Add Customer</button>
                        </div>
                    </div>
                </form>
            </div>
